...
#     summary: str
#     sentiment:Annotated[Literal["pos","neg"], "write down the sentiments form review "]
#     pros: Annotated[Optional[list[str]],"write down the list of pros from review, if not ignore it "]
